				...
				<section className="relative py-20 md:py-28 overflow-hidden">
					...
					<div className="container mx-auto px-4">
						...
						<div className="relative group">
							...
							<div className="relative bg-white/[0.82] rounded-2xl border border-[#0066CC]/20 ring-1 ring-blue-50 p-10 shadow-md hover:shadow-2xl transition-all duration-300">
					...
					<div className="container mx-auto px-4 py-20">
						...
						<div className="grid md:grid-cols-3 gap-8">
							<div className="group relative">
								...
								<div className="relative p-8 bg-white/[0.82] rounded-2xl border border-[#0066CC]/20 ring-1 ring-blue-50 shadow-md hover:shadow-2xl transition-all duration-300 h-full border-l-4 border-l-[#5191c4]">
